...
public class WorldChanelCommand extends AbstractCommand {

	public WorldChanelCommand(ChatManager plugin, Chanel chanel) {
		super(plugin, chanel);
	}
	...
	public CommandResult execute(CommandContext context) throws CommandException {
		...
		if(!chanel.isAllowedWorld(world)) exception(plugin.getLocales().getText(locale, LocalesPaths.INVALID_WORLD));
